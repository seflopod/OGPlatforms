...
{
	[CustomPropertyDrawer(typeof(PrivateFloatRangeAttribute))]
	public class PrivateFloatRangeDrawer : PropertyDrawer
	{
		...
		public override void OnGUI(Rect pos, SerializedProperty prop, GUIContent label)
		{
			...
			prop.floatValue = EditorGUI.Slider(contentRect, prop.floatValue, privateRangeAttribute.minValue, privateRangeAttribute.maxValue);
		}

		//property for easier internal access to the attribute
		private PrivateFloatRangeAttribute privateRangeAttribute { get { return (PrivateFloatRangeAttribute)attribute; } }
	}
}
