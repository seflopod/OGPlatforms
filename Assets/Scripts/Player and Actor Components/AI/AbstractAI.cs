...
public delegate void AIStateChangeHandler(object sender, AIStateChangeEventArgs e);
...
public abstract class AbstractAI : MonoBehaviour
{
	...
	public event AIStateChangeHandler AIStateChange;

	private aiStateFunc _currentState;

	public string CurrentStateName
	{
		get { return _currentState.Method.Name; }
	}

	protected aiStateFunc CurrentState { get { return _currentState; } }
	...
	{
		//do nothing?
		//should have base death behaviour?
	}
	#endregion

	public void ChangeState(aiStateFunc newState)
	{
		string oldName = CurrentStateName;
		_currentState = newState;
		AIStateChangeHandler handler = AIStateChange;
		if(handler != null)
		{
			handler(this, new AIStateChangeEventArgs(oldName, CurrentStateName));
		}
	}
